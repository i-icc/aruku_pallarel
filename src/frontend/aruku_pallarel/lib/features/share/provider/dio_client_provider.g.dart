...
final authTokenInterceptorProvider = Provider<Interceptor>.internal(
  authTokenInterceptor,
  name: r'authTokenInterceptorProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$authTokenInterceptorHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef AuthTokenInterceptorRef = ProviderRef<Interceptor>;
